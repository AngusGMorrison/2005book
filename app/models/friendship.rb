class Friendship < ApplicationRecord
    ...
    def self.get_friendship(user_1_id, user_2_id)
        Friendship.find_by(user_1_id: user_1_id, user_2_id: user_2_id) || Friendship.find_by(user_1_id: user_2_id, user_2_id: user_1_id)
    end
